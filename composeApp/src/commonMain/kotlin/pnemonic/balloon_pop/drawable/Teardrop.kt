...
fun Teardrop(@FloatRange(0.0, 360.0) hue: Float): ImageVector {
    return ImageVector.Builder(
        ...
        path(
            fill = SolidColor(Color(0xFF686AD4).hue(hue)),
            fillAlpha = 0.49f,
            strokeAlpha = 0.49f
        ) {
            ...
            path(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                        ...
                        0.839f to Color(0xFF5C6BF7).hue(hue),
                        0.89f to Color(0xFF7382F5).hue(hue),
                        0.943f to Color(0xFF92A1F3).hue(hue),
                        0.998f to Color(0xFFBAC9EF).hue(hue),
                        1f to Color(0xFFBCCBEF).hue(hue)
                    ),
