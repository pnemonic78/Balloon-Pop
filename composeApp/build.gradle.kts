...
android {
    namespace = "pnemonic.balloon_pop"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "pnemonic.balloon_pop"
...
compose.desktop {
    application {
        mainClass = "pnemonic.balloon_pop.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "pnemonic.balloon_pop"
            packageVersion = "${versionMajor}.${versionMinor}.${versionBuild}"

            macOS {
                bundleID = "pnemonic.balloon-pop"
